...
namespace F21Party.Controllers
{
    internal class CtrlFrmPositionList
    {
        ...
        public void ShowData()
        {
            ...
            frmPositionList.dgvPositionSetting.Columns[0].FillWeight = 33;
            frmPositionList.dgvPositionSetting.Columns[1].FillWeight = 33;
            frmPositionList.dgvPositionSetting.Columns[2].FillWeight = 34;
