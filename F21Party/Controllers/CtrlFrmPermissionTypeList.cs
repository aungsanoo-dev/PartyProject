...
namespace F21Party.Controllers
{
    internal class CtrlFrmPermissionTypeList
    {
        ...
        public void ShowData()
        {
            ...
            frmPermissionTypeList.dgvPermissionTypeSetting.Columns[0].FillWeight = 33;
            frmPermissionTypeList.dgvPermissionTypeSetting.Columns[1].FillWeight = 33;
            frmPermissionTypeList.dgvPermissionTypeSetting.Columns[2].FillWeight = 34;
