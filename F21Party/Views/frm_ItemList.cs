...
namespace F21Party.Views
{
    public partial class frm_ItemList : Form
    {
        ...
        DbaConnection obj_clsMainDB = new DbaConnection();
        string SPString = "";
        frm_CreatePosition frm = new frm_CreatePosition();
        ...
        private void ShowData()
        {
            ...
            dgvItem.Columns[2].Width = (dgvItem.Width / 100) * 50;
            dgvItem.Columns[3].Width = (dgvItem.Width / 100) * 20;
            dgvItem.Columns[4].Width = (dgvItem.Width / 100) * 20;

            obj_clsMainDB.ToolStripTextBoxData(tstSearchWith, SPString, "ItemName");
        ...
        private void tsmQty_Click(object sender, EventArgs e)
        {
            tslLabel.Text = "Qty";
            SPString = string.Format("SP_Select_Item N'{0}',N'{1}',N'{2}'", "0", "0", "0");
            obj_clsMainDB.ToolStripTextBoxData(tstSearchWith, SPString, "Qty");
        }
        ...
        private void tsmPrice_Click(object sender, EventArgs e)
        {
            tslLabel.Text = "Price";
            SPString = string.Format("SP_Select_Item N'{0}',N'{1}',N'{2}'", "0", "0", "0");
            obj_clsMainDB.ToolStripTextBoxData(tstSearchWith, SPString, "Price");
        }
